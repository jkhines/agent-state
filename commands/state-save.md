...
4. Read `prompt.md`, `context.json`, `notes.md`, and any patch artifacts from the bundle, then rewrite `resume.md`
   with these sections:
...
5. If `status=ready-for-review`, suggest `/state-archive`.
