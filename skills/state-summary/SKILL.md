...
name: state-summary
description: >-
  Builds a concise summary of active and recently archived agent-state bundles,
  optionally flagging stale work. Use when the user invokes /state-summary,
  asks what tasks are active, or needs a cross-task overview.
